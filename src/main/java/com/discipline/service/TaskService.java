...
public class TaskService {
    ...
    public Task update(Long id, TaskUpdateDTO dto) {
        ...
        if (dto.getTagColor() != null) task.setTagColor(dto.getTagColor());
        if (dto.getDueDate() != null) task.setDueDate(LocalDate.parse(dto.getDueDate()));
        if (dto.getOrderIndex() != null) task.setOrderIndex(dto.getOrderIndex());
